...
func TestNewDeviceCodeFlow(t *testing.T) {
	...
	if flow == nil {
		t.Fatalf("expected non-nil flow")
	}
...
func TestDisplayDeviceCodePromptWithVerificationURL(t *testing.T) {
	...
	buf := &bytes.Buffer{}
	displayDeviceCodePrompt(buf, response)
	output := buf.String()
...
func TestDisplayDeviceCodePromptNilResponse(t *testing.T) {
	buf := &bytes.Buffer{}
	displayDeviceCodePrompt(buf, nil)
	output := buf.String()
	if output != "" {
...
func TestDisplayDeviceCodePromptNilWriter(t *testing.T) {
	...
	displayDeviceCodePrompt(nil, response)
}
...
func TestDisplayDeviceCodePromptWriterError(t *testing.T) {
	...
	displayDeviceCodePrompt(failingWriter, response)
}
